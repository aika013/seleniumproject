...
public class ExtentReportExample {
    ...
    //used to set up a new and build reports
    ...
    public void setUp() {
        ...
        // /Users/aiganyshtukueva/IdeaProjects/fall-2019-selenium-project

        //System.getProperty("user.dir") --> ges my current folder
        // + "test-output/report.html" --> create folder test-uotput and in it create file report.html
        ...
        htmlReporter.config().setReportName("Vytrack Automation Test");
